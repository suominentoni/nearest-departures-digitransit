...
public let TransitData = _TransitData.sharedInstance

public class _TransitData {
    ...
    public func departuresForStop(_ gtfsId: String, callback: @escaping (_ departures: [Departure]) -> Void) -> Void {
    ...
    public func coordinatesForStop(_ stop: Stop, callback: @escaping (_ lat: Double, _ lon: Double) -> Void) -> Void {
